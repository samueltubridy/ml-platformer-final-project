...
with a reward structure determined by progress through the stage.
...
# Results
- Trained agent over 660,000 steps in 1 hour
- Agent successfully completes the obstacle course
